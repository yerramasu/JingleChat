...
public final class Config {
	...
	public static final String DOMAIN_LOCK = "chat.jingle.im"; //only allow account creation for this domain
	public static final String MAGIC_CREATE_DOMAIN = "chat.jingle.im";
